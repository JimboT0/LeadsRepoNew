        ...
        <div>
            <div className="w-[100%] h-100vh  flex flex-col md:flex-row justify-center items-center text-center">
                <div style={{
                    ...
                    <br />that You May Have Lying Around Your House</div>
            ...
            <div className="w-[100%] h-100vh p-10 flex flex-col justify-center items-center text-center">
                <div className=' flex flex-col justify-center items-center text-center'>
                    <div>
                        ...
                        <Image alt='image' className="w-[486px] h-[200px] rounded-[20px] m-10 mx-auto" src="https://via.placeholder.com/486x200" />
                    ...
                    <div>
                        ...
                        WeVll guide you through the process of identifying and selling items that could change your financial landscape. From
                            timepieces
                            ,
                            automobiles
                            ,
